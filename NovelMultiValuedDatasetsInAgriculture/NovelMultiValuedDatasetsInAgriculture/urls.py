...
from NovelMultiValuedDatasetsInAgriculture import views as mainView
...
urlpatterns = [
    ...
    path("Naivebayes", usr.Naivebayes, name="Naivebayes"),
    path("Mlp/", usr.Mlp, name="Mlp"),
    path("Prediction/", usr.Prediction, name="Prediction"),
    path("Approch", usr.Approch, name="Approch")
]
